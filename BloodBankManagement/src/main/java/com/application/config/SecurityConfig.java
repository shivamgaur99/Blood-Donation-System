...
public class SecurityConfig extends WebSecurityConfigurerAdapter
{
	...
	protected void configure(HttpSecurity http) throws Exception 
	{
        http.csrf().disable().authorizeRequests().antMatchers("/authenticate")
                .permitAll().antMatchers("/profileDetails/{email}","/login","/register","/updateuser","/logout")
                .permitAll().antMatchers("/bloodDetails","/addDonor","/addAsDonor","/updateStatus/{email}","/acceptstatus/{email}","/rejectstatus/{email}")
